        ...
        return http.csrf(csrf -> csrf.disable())
                    ...
                    .authorizeHttpRequests(
                        authorize -> authorize
                            ...
                            .requestMatchers(HttpMethod.GET, "/api/order").hasAnyRole("ADMIN", "EMPLOYER")
                            .requestMatchers(HttpMethod.DELETE, "/api/order").hasAnyRole("ADMIN", "EMPLOYER")
                            .requestMatchers(HttpMethod.POST, "/api/order").hasAnyRole("ADMIN", "EMPLOYER")
                            .requestMatchers(HttpMethod.PUT, "/api/order/*/status").hasRole("ADMIN")
                            .requestMatchers(HttpMethod.GET, "/api/category").hasAnyRole("ADMIN", "EMPLOYER")
                            .requestMatchers(HttpMethod.DELETE, "/api/category").hasAnyRole("ADMIN", "EMPLOYER")
                            .requestMatchers(HttpMethod.POST, "/api/category").hasAnyRole("ADMIN", "EMPLOYER")
                            .requestMatchers(HttpMethod.PUT, "/api/category").hasAnyRole("ADMIN", "EMPLOYER")
                            .anyRequest().denyAll()
                    )
